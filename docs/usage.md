...
```bash
nextflow run sanger-tol/sequencecomposition --input ./samplesheet.csv --outdir ./results --genome GRCh37 -profile docker
```
...
```bash
nextflow run sanger-tol/sequencecomposition -profile docker -params-file params.yaml
```
